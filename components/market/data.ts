...
export const marketPages: Record<string, MarketPageData> = {
  "animal-nutrition": {
    hero: {
      ...
      image: "/images/market/animal.webp",
      imageMobile: "/mobile/markets/animal.webp",
      className: "mt-auto",
    },
    ...
    products: [
      {
        title: { type: "icon", src: "/images/product/aviglyHP.webp", className: "w-34" },
        subtitle: "products.avigly_hp.subtitle",
        desc: "products.avigly_hp.desc",
        image: "/images/market/image.webp",
        link: "/product/amino-acids/avigly-hp",
      },
      {
        title: { type: "icon", src: "/images/product/avitau.webp", className: "mb-2" },
        subtitle: "products.avitau.subtitle",
        desc: "products.avitau.desc",
        image: "/images/market/image15.webp",
  ...
  "food-and-beverages": {
    hero: {
      title: "hero.title",
      subtitle: "hero.subtitle",
      image: "/images/market/food-beverages.webp",
      imageMobile: "/mobile/markets/food-beverages.webp",
      className: "mt-auto",
    },
    description: "description",
    solutions: [
    ...
    products: [
      {
        ...
        subtitle: "products.avigly_hp.subtitle",
        desc: "products.avigly_hp.desc",
        image: "/images/market/image18.webp",
        link: "/product/amino-acids/avigly-hp",
      },
      {
        title: { type: "icon", src: "/images/product/avitau.webp", className: "mb-2" },
  ...
  "industrial-and-specialty-applications": {
    hero: {
      title: "hero.title",
      subtitle: "hero.subtitle",
      image: "/images/market/industry.webp",
      imageMobile: "/mobile/markets/industry.webp",
      className: "my-auto",
    },
    description: "description",
    solutions: [
    ...
    products: [
      {
        title: { type: "icon", src: "/images/product/avigabioT.webp", className: "mb-2" },
      ...
      },
      {
        ...
        image: "/images/market/image10.webp",
  ...
  "personal-care-and-cosmetics": {
    hero: {
      title: "hero.title",
      subtitle: "hero.subtitle",
      image: "/images/market/personal-care.webp",
      imageMobile: "/mobile/markets/personal-care.webp",
    ...
    products: [
      {
        title: { type: "icon", src: "/images/product/avigabioHP70.webp", className: "w-40 mb-2" },
        ...
        image: "/images/market/image19.webp",
        link: "/product/alpha-hydroxy-acids/aviga-bio-hp-70",
      },
      {
        title: { type: "icon", src: "/images/product/avigaHP70.webp", className: "w-30 mb-2" },
        subtitle: "products.aviga_hp.subtitle",
        desc: "products.aviga_hp.desc",
        image: "/images/market/image17.webp",
      ...
      },
      {
        ...
        subtitle: "products.avigly_hp.subtitle",
        desc: "products.avigly_hp.desc",
        image: "/images/market/image8.webp",
        link: "/product/amino-acids/avigly-hp",
      },
      {
        title: { type: "icon", src: "/images/product/avitau.webp", className: "object-contain mb-1" },
        subtitle: "products.avitau.subtitle",
        desc: "products.avitau.desc",
        image: "/images/market/image9.webp",
        link: "/product/amino-acids/avitau",
      },
      {
        title: { type: "text", src: "Chlorhexidine" },
        ...
        image: "/images/market/image7.webp",
        link: "/product/specialty-chemicals-and-intermediates/chlorhexidine-base",
      },
    ],
    productButton: {
  ...
  pharmaceuticals: {
    hero: {
      title: "hero.title",
      subtitle: "hero.subtitle",
      image: "/images/market/pharma.webp",
      imageMobile: "/mobile/markets/pharma.webp",
      className: "ml-auto mt-auto",
    },
    description: "description",
    solutions: [
    ...
    products: [
      ...
      },
      {
        ...
        subtitle: "products.avitau.subtitle",
        desc: "products.avitau.desc",
        image: "/images/market/image13.webp",
        link: "/product/amino-acids/avitau",
      },
      {
        title: { type: "text", src: "Chlorhexidine" },
