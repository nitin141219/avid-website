...
const excellences = [
  {
    ...
    image: "/images/manufacturing-excellence/pt.jpg",
  },
  {
    key: "researchDevelopment",
    image: "/images/manufacturing-excellence/rnd.jpg",
  },
  {
    key: "supplyChainReliability",
    image: "/images/manufacturing-excellence/scr.jpg",
  },
  {
    key: "qualityControlAssurance",
    image: "/images/manufacturing-excellence/qca.jpg",
  },
];
    ...
    <div className="space-y-16 py-16 container-inner">
      ...
      <section className="bg-gray-section">
        <div className="z-0 relative bg-primary p-16 text-white">
          <Image
            src="/images/manufacturing-excellence/amd.jpg"
            fill
            alt="Our Story"
        ...
        <div className="p-16">
          ...
          <div className="flex flex-wrap items-center gap-2 my-8">
            {[
              { id: 1, src: "/images/sustainability/fssai.png", size: "h-12" },
              { id: 2, src: "/images/sustainability/reach.png", size: "h-22" },
              { id: 3, src: "/images/certificates/fdca.png", size: "h-22" },
              { id: 4, src: "/images/certificates/esg.png", size: "h-22" },
              { id: 5, src: "/images/footer/logo1.png", size: "h-22" },
              { id: 6, src: "/images/sustainability/sgs14.png", size: "h-22" },
              { id: 7, src: "/images/sustainability/sgs45.png", size: "h-22" },
              { id: 8, src: "/images/footer/logo3.png", size: "h-22" },
              { id: 9, src: "/images/footer/logo6.png", size: "h-22" },
              { id: 10, src: "/images/sustainability/smeta.png", size: "h-18" },
            ].map((i) => (
              <Image
                src={i.src}
                key={i.id}
