class SilktideCookieBanner {
    ...
    getBannerContent() {
        ...
        // Silktide logo link
        const silktideLogo = `
      <a class="silktide-logo" href="http://localhost:3000/en/privacy-policy" target="_blank" rel="noreferrer" aria-label="Read the Privacy Policy of AVID Organics PVT LTD">
    ...
    getModalContent() {
      ...
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        const creditLink = `<a href="http://localhost:3000/en/privacy-policy" target="_blank" rel="noreferrer"${creditLinkAccessibleLabel && creditLinkAccessibleLabel !== creditLinkText
